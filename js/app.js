...
const scrolling = () => {
    ...
    links.forEach(link => {
        link.addEventListener('click', (event) => { // Add the event parameter
            event.preventDefault(); // Prevent the default navigation behavior
            const targetSectionId = link.getAttribute('href'); // Get the target section's ID from the link's href attribute
